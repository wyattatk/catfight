...
// catfight: one more than upstream. Stream 0 is cinematics and background
// music, 1 .. MAX_CLIENTS*2 are VoIP, and the companion gets her own on the
// end -- see RAW_STREAM_COMPANION in snd_public.h. Sharing a stream would mean
// her voice could be cut off by whatever else happened to be using it.
#define MAX_RAW_STREAMS (MAX_CLIENTS * 2 + 2)
