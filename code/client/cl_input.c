...
void CL_InitInput( void ) {
	...
	// catfight: reloading is button2. default.cfg has bound r to "+reload"
	// since before there were weapons, and that command did not exist -- so
	// the key did nothing at all. Aliasing it here is what makes the bind mean
	// what it reads as, rather than rewriting every config to say "+button2".
	Cmd_AddCommand ("+reload", IN_Button2Down);
	Cmd_AddCommand ("-reload", IN_Button2Up);
