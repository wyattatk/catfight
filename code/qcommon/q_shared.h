...
#ifdef STANDALONE
  #define PRODUCT_NAME				"catfight"
  #define BASEGAME					"catfight"
  #define CLIENT_WINDOW_TITLE		"Catfight"
  #define CLIENT_WINDOW_MIN_TITLE	"Catfight"
  #define HOMEPATH_NAME_UNIX_LEGACY	".catfight"
  #define HOMEPATH_NAME				"Catfight"
  #define GAMENAME_FOR_MASTER		"catfight"	// must NOT contain whitespace
// No startup cinematics. Both defines are #ifdef-guarded at their use sites
// (common.c Com_Init, ui_main.c), so leaving them undefined skips the intro
// entirely rather than trying to play a missing .roq.
//  #define CINEMATICS_LOGO		"catfight_logo.roq"
//  #define CINEMATICS_INTRO		"catfight_intro.roq"
//  #define LEGACY_PROTOCOL	// deliberately off: we do not talk to Quake 3 clients
//  #define PROTOCOL_HANDLER		"catfight"
  #define CONFIG_PREFIX			"catfightconfig"
#else
