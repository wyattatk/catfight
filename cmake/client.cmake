...
set(CLIENT_SOURCES
    ...
    # catfight: matchmaking. cl_http_req.c and cl_mm.c are listed
    # unconditionally rather than under USE_HTTP like the platform backends --
    # both guard themselves internally, and cl_mm.c keeps the mm_* commands
    # registered in a non-HTTP build so they explain themselves instead of
    # reading as typos.
    ${SOURCE_DIR}/client/cl_http_req.c
    ${SOURCE_DIR}/client/cl_mm.c
    ${SOURCE_DIR}/qcommon/cf_json.c

    # catfight: the engine's side of the Steam helper. Unconditional, and
    # independent of USE_HTTP -- it links nothing, and a platform with no
    # process model gets sys_process_null.c below. NOTHING STEAMWORKS IS
    # LINKED HERE OR ANYWHERE IN THIS BINARY; see steam/README.md.
    ${SOURCE_DIR}/client/cl_steam.c

    # catfight: the engine's side of the companion helper, on the same terms.
    # NO MODEL, NO PROMPT AND NO PERSONA IS COMPILED INTO THIS BINARY -- all of
    # that lives in a separate program; see cfvoice/README.md.
    ${SOURCE_DIR}/client/cl_voice.c
