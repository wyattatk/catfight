...
set(CF_SHARED_SOURCES
    ...
    ${SOURCE_DIR}/cf_shared/cf_binds.c
...
set(CF_GAME_SOURCES
    ...
    ${SOURCE_DIR}/cf_game/g_botai.c
    ${SOURCE_DIR}/cf_game/g_botcmd.c
    ${SOURCE_DIR}/cf_game/g_botnav.c
    ${SOURCE_DIR}/cf_game/g_botroute.c
    ${SOURCE_DIR}/cf_game/g_lagcomp.c
...
set(CF_CGAME_SOURCES
    ...
    ${SOURCE_DIR}/cf_cgame/cg_players.c
    ${SOURCE_DIR}/cf_cgame/cg_weapon.c
    ${SOURCE_DIR}/cf_cgame/cg_predict.c
    ${SOURCE_DIR}/cf_cgame/cg_snapshot.c
    ${SOURCE_DIR}/cf_cgame/cg_servercmds.c
    # What the companion is told about the match. Here rather than in the
    # engine because deciding that stats[7] is her health is game knowledge.
    ${SOURCE_DIR}/cf_cgame/cg_voice.c
    ${SOURCE_DIR}/cf_cgame/cg_syscalls.c
)

set(CF_UI_SOURCES
    ${SOURCE_DIR}/cf_ui/ui_main.c
    ${SOURCE_DIR}/cf_ui/ui_binds.c
