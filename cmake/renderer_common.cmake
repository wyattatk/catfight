...
# catfight: the renderer creates the game window (sdl/sdl_glimp.c), and the
# window title comes from CLIENT_WINDOW_TITLE in q_shared.h, which is chosen by
# STANDALONE. Upstream only passes STANDALONE to the client and server targets,
# so without this the window is titled "ioquake3" no matter how the game is
# branded everywhere else.
if(BUILD_STANDALONE)
